...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _api_url_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./api_url.js */ \"./src/modules/api_url.js\");\n\n\nconst persons = document.querySelector('.board-1 .table');\n\nconst outcomeScores = async () => {\n  const newScore = await (0,_api_url_js__WEBPACK_IMPORTED_MODULE_0__.urlScores)();\n  newScore.result.forEach((score) => {\n    const person = document.createElement('li');\n    const span = document.createElement('span');\n    span.textContent = score.score;\n    person.className = 'table-records';\n    person.textContent = `${score.user}`;\n    person.appendChild(span);\n    persons.appendChild(person);\n  });\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (outcomeScores);\n\n\n//# sourceURL=webpack://leaderboard/./src/modules/scores.js?");
